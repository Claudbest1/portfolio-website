		...
		<section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
			<div className="container mx-auto max-w-4xl">
				...
				<div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
					...
					<p>
						Currently, I'm an Intermediate Front-End Engineer specializing in
						accessibility. I contribute to the creation and maintenance of UI
						components that power modern web applications, ensuring our platform
					...
					<p>
						...
						years ago, guiding learners through building a web app with modern
						technologies.
					</p>
				</div>
			</div>
